...
public:
  MachineBinaryInst(MachineBlock *parent, Binary_Inst opcode,
                    MachineOperand *rd, MachineOperand *rs1,
                    MachineOperand *rs2);
...
public:
  MachineLoadInst(MachineBlock *parent, Load_Inst opcode, MachineOperand *rd,
                  MachineOperand *rs1);
  void PrintInst(std::ofstream &outputFile);
};
...
public:
  MachineStoreInst(Store_Inst opcode, MachineOperand *rs2, MachineOperand *rs1,
                   MachineOperand *offset);
  MachineStoreInst(MachineBlock *parent, Store_Inst opcode, MachineOperand *rs2,
                   MachineOperand *rs1, MachineOperand *offset);
  void PrintInst(std::ofstream &outputFile);
};
...
public:
  MachineBranchInst(MachineBlock *parent, Branch_Inst opcode,
                    MachineOperand *rs1, MachineOperand *rs2);
  MachineBranchInst(MachineBlock *parent, Branch_Inst opcode,
                    MachineOperand *rs1);
  void PrintInst(std::ofstream &outputFile);
};
...
public:
  MachineCmpInst(MachineBlock *parent, Cmp_Inst opcode, MachineOperand *rd,
                 MachineOperand *rs1, MachineOperand *rs2);
  MachineCmpInst(MachineBlock *parent, Cmp_Inst opcode, MachineOperand *rd,
                 MachineOperand *rs1);
  void PrintInst(std::ofstream &outputFile);
...
public:
  PseudoInst(MachineBlock *parent, Pseudo_Inst opcode, MachineOperand *rd,
             MachineOperand *rs1);
