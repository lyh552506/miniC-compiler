...
public:
    ...
    int getType();
    std::vector<MachineOperand *> &getDefList() { return defList; }
    std::vector<MachineOperand *> &getUseList() { return useList; }
...
public:
    BinaryInst(MachineBlock *parent, Binary_Inst opcode, MachineOperand *rd,
...
public:
    LoadInst(MachineBlock *parent, Load_Inst opcode, MachineOperand *rd,
             MachineOperand *rs1);
    void PrintInst(std::ofstream &outputFile);
};
...
public:
    StoreInst(MachineBlock *parent, Store_Inst opcode, MachineOperand *rs2,
...
public:
    CmpInst(MachineBlock *parent, Cmp_Inst opcode, MachineOperand *rd,
            MachineOperand *rs1, MachineOperand *rs2);
    CmpInst(MachineBlock *parent, Cmp_Inst opcode, MachineOperand *rd,
            MachineOperand *rs1);
    void PrintInst(std::ofstream &outputFile);
