...
define void @loop1(i32 %.12, i32 %.15){
.11:
  %.24 = alloca i32
  %.23 = alloca i32
  %.22 = alloca i32
...
define i32 @loop3(i32 %.256, i32 %.259, i32 %.262, i32 %.265, i32 %.268, i32 %.271, i32 %.274){
.255:
  %.284 = alloca i32
  %.283 = alloca i32
  %.282 = alloca i32
