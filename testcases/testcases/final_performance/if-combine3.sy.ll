...
.18wloop.8.11:
  %.24 = load i32, i32* %.15
  %.25 = getelementptr inbounds [100 x i32], [100 x i32]* %.14, i32 0, i32 %.24
  store i32 0, i32* %.25
  %.27 = load i32, i32* %.15
  %.29 = add i32 %.27, 1
  store i32 %.29, i32* %.15
...
.935wc312:
  ...
  %.940 = icmp slt i32 %.939, 100
  br i1 %.940, label %.936wloop.312.315, label %.937wn315
.936wloop.312.315:
  %.942 = load i32, i32* %.5
  %.943 = load i32, i32* %.933
  %.944 = getelementptr inbounds [100 x i32], [100 x i32]* %.14, i32 0, i32 %.943
  %.945 = load i32, i32* %.944
  %.946 = add i32 %.942, %.945
  store i32 %.946, i32* %.5
  %.948 = load i32, i32* %.933
  %.949 = add i32 %.948, 1
  store i32 %.949, i32* %.933
  br label %.935wc312 
.937wn315:
  %.952 = load i32, i32* %.5
  %.954 = srem i32 %.952, 65535
  store i32 %.954, i32* %.5
  br label %.32wc12 
}
define i32 @main(){
.960:
  ...
  store i32 %.966at325, i32* %.964
  %.968 = load i32, i32* %.964
  %.969at326 = call i32 @func(i32 %.968)
