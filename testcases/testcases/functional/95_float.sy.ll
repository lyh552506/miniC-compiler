...
attributes #7 = { cold }
@__constant..185 = constant [10 x float]  [float 0x3ff0000000000000, float 0x4000000000000000, float zeroinitializer, float zeroinitializer, float zeroinitializer, float zeroinitializer, float zeroinitializer, float zeroinitializer, float zeroinitializer, float zeroinitializer]
...
.177:
  store i32 1, i32* %.179
  store i32 0, i32* %.181
  call void @llvm.memcpy.p0.p0.i32([10 x float]* %.183, [10 x float]* @__constant..185, i32 40, i1 false)
  %.190 = getelementptr inbounds [10 x float], [10 x float]* %.183, i32 0, i32 0
  %.192at82 = call i32 @getfarray(float* %.190)
  store i32 %.192at82, i32* %.189
  br label %.194wc83 
.194wc83:
  %.198 = load i32, i32* %.179
  %.199 = icmp slt i32 %.198, 1000000000
  br i1 %.199, label %.195wloop.83.95, label %.196wn95
.195wloop.83.95:
  %.203at84 = call float @getfloat()
  store float %.203at84, float* %.201
  %.206 = load float, float* %.201
  %.207 = fmul float 0x400921fb60000000, %.206
  %.208 = load float, float* %.201
  %.209 = fmul float %.207, %.208
  store float %.209, float* %.205
  %.212 = load float, float* %.201
  %.213 = fptosi float %.212 to i32
  %.214at85 = call float @circle_area(i32 %.213)
  store float %.214at85, float* %.211
  %.216 = load i32, i32* %.181
  %.217 = getelementptr inbounds [10 x float], [10 x float]* %.183, i32 0, i32 %.216
  %.218 = load float, float* %.217
  %.219 = load float, float* %.201
  %.220 = fadd float %.218, %.219
  %.221 = load i32, i32* %.181
  %.222 = getelementptr inbounds [10 x float], [10 x float]* %.183, i32 0, i32 %.221
  store float %.220, float* %.222
  %.224 = load float, float* %.205
  call void @putfloat(float %.224)
  call void @putch(i32 32)
  %.229 = load float, float* %.211
  %.230 = fptosi float %.229 to i32
  call void @putint(i32 %.230)
  call void @putch(i32 10)
  %.234 = load i32, i32* %.179
  %.237 = sitofp i32 %.234 to float
  %.238 = fmul float %.237, 0x4024000000000000
  %.239 = fptosi float %.238 to i32
  store i32 %.239, i32* %.179
  %.241 = load i32, i32* %.181
  %.242 = add i32 %.241, 1
  store i32 %.242, i32* %.181
  br label %.194wc83 
.196wn95:
  %.245 = load i32, i32* %.189
  %.246 = getelementptr inbounds [10 x float], [10 x float]* %.183, i32 0, i32 0
  call void @putfarray(i32 %.245, float* %.246)
  ret i32 0 
}
@__constant..185 = constant [10 x float]  [float 0x3ff0000000000000, float 0x4000000000000000, float zeroinitializer, float zeroinitializer, float zeroinitializer, float zeroinitializer, float zeroinitializer, float zeroinitializer, float zeroinitializer, float zeroinitializer]
define float @float_abs(float %.25){
