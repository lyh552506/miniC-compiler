...
@__constant..58 = constant [2 x [8 x i32]]  [[8 x i32]  [i32 0, i32 9, i32 zeroinitializer, i32 zeroinitializer, i32 zeroinitializer, i32 zeroinitializer, i32 zeroinitializer, i32 zeroinitializer], [8 x i32]  [i32 8, i32 3, i32 zeroinitializer, i32 zeroinitializer, i32 zeroinitializer, i32 zeroinitializer, i32 zeroinitializer, i32 zeroinitializer]]
@__constant..80 = constant [7 x [1 x [5 x i32]]]  [[1 x [5 x i32]] zeroinitializer, [1 x [5 x i32]] zeroinitializer, [1 x [5 x i32]]  [[5 x i32]  [i32 2, i32 1, i32 8, i32 zeroinitializer, i32 zeroinitializer]], [1 x [5 x i32]]  [[5 x i32] zeroinitializer], [1 x [5 x i32]] zeroinitializer, [1 x [5 x i32]] zeroinitializer, [1 x [5 x i32]] zeroinitializer]
define i32 @main(){
.10:
...
.29wc20:
  ...
  br i1 %.34, label %.30wloop.20.25, label %.31wn25
.30wloop.20.25:
  store i32 0, i32* %.36
  %.39 = load i32, i32* %.36
  %.40 = add i32 %.39, 1
...
.31wn25:
  ...
  store i32 1, i32* %.52
  call void @llvm.memcpy.p0.p0.i32([2 x [8 x i32]]* %.54, [2 x [8 x i32]]* @__constant..58, i32 64, i1 false)
  store i32 2, i32* %.64
...
.43:
  br label %.29wc20 
.66:
  call void @llvm.memcpy.p0.p0.i32([7 x [1 x [5 x i32]]]* %.72, [7 x [1 x [5 x i32]]]* @__constant..80, i32 140, i1 false)
  %.83 = load i32, i32* %.64
  %.84 = getelementptr inbounds [7 x [1 x [5 x i32]]], [7 x [1 x [5 x i32]]]* %.72, i32 0, i32 %.83, i32 0, i32 0
  %.85 = load i32, i32* %.84
  call void @putint(i32 %.85)
  %.87 = load i32, i32* %.64
  %.88 = getelementptr inbounds [7 x [1 x [5 x i32]]], [7 x [1 x [5 x i32]]]* %.72, i32 0, i32 %.87, i32 0, i32 1
  %.89 = load i32, i32* %.88
  call void @putint(i32 %.89)
  %.91 = load i32, i32* %.64
  %.92 = getelementptr inbounds [7 x [1 x [5 x i32]]], [7 x [1 x [5 x i32]]]* %.72, i32 0, i32 %.91, i32 0, i32 2
  %.93 = load i32, i32* %.92
